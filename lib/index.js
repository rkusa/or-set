...
OrSet.prototype = Object.create({
  ...
  add: function(e, u) {
    ...
    var transformed = this._transform(e)
    ...
    if (u) {
      ...
      if (index === -1) {
        index = this._elements.push(transformed) - 1
      }
    }
    // local
    else {
    ...
    if (typeof Object.getNotifier === 'function') {
      Object.getNotifier(this).notify({
        type: 'add', name: utag, value: transformed
      })

      Object.getNotifier(this).notify({
        type: 'update', name: 'size', oldValue: this.size - 1
      })
    }
  },
